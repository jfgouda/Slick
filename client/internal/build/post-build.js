...
child_process.exec('start chrome https://localhost/sketchgenerator/');
console.log(colors.green(`Application hosted on: ${colors.yellow("https://localhost/sketchgenerator/")}`));
